...
public class LvxingsheCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public LvxingsheCollectionEntity() {

	}

	public LvxingsheCollectionEntity(T t) {
		try {
