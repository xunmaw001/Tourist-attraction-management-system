...
public class LvxingsheLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public LvxingsheLiuyanEntity() {

	}

	public LvxingsheLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "LvxingsheLiuyan{" +
            "id=" + id +
            ", lvxingsheId=" + lvxingsheId +
            ", yonghuId=" + yonghuId +
            ", lvxingsheLiuyanContent=" + lvxingsheLiuyanContent +
