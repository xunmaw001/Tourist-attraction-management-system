...
public class LvxingsheLiuyanView extends LvxingsheLiuyanEntity implements Serializable {
	...
	public LvxingsheLiuyanView() {

	}

	public LvxingsheLiuyanView(LvxingsheLiuyanEntity lvxingsheLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, lvxingsheLiuyanEntity);
