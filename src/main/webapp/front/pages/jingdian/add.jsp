        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.jingdianName" type="text" name="jingdianName" id="jingdianName" placeholder="景点名" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div v-if="detail.jingdianPhoto" class="layui-input-block">
                    <img id="jingdianPhotoImg"
                         style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;"
                         :src="detail.jingdianPhoto">
                    <input type="hidden" :value="detail.jingdianPhoto" id="jingdianPhoto" name="jingdianPhoto"/>
                </div>
                <div class="layui-input-block">
                    <button type="button" class="layui-btn btn-theme" id="jingdianPhotoUpload">
                        <i class="layui-icon">&#xe67c;</i>上传景点缩略图
                    </button>
                </div>
            </div>
                    <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.jingdianTese" type="text" name="jingdianTese" id="jingdianTese" placeholder="景点特色" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.jingdianLuxian" type="text" name="jingdianLuxian" id="jingdianLuxian" placeholder="景点路线" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
    ...
    layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate', 'tinymce'], function () {
       ...
       initializationJingdiandengjitypesSelect();
        ...
        form.on('submit(thisSubmit)', function (data) {
            ...
            // 提交数据
            http.requestJson('jingdian' + '/add', 'post', data, function (res) {
                layer.msg('提交成功', {
                    time: 2000,
                    icon: 6
                }, function () {
