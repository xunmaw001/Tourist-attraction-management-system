...
<div id="app">
    <div class="data-detail">
        <div class="data-detail-breadcrumb">
            ...
            <!-- 收藏 -->
            <a onclick="addJingdianCollection()" href="javascript:void(0)">
        ...
        <div class="layui-row">
            ...
            <div class="layui-col-md7" style="padding-left: 20px;">
                <h1 class="title">{{detail.jingdianName}}</h1>

                <div v-if="detail.jingdianTypes" class="detail-item">
                    <span>景点类型：</span>
                    <span class="desc">
                ...
                <div v-if="detail.jingdianDengjiTypes" class="detail-item">
                    <span>景点等级：</span>
                    <span class="desc">
                        {{detail.jingdianDengjiValue}}
                    </span>
                </div>

                <div v-if="detail.jingdianTese" class="detail-item">
                    <span>景点特色：</span>
                    <span class="desc">
                                {{detail.jingdianTese}}
                            </span>
                ...
                <div v-if="detail.jingdianLuxian" class="detail-item">
                    <span>景点路线：</span>
                    <span class="desc">
                                {{detail.jingdianLuxian}}
                            </span>
                </div>

                <div v-if="detail.jingdianNewMoney" class="detail-item">
                    <span>门票参考价格：</span>
                ...
                <div class="detail-item">
                    ...
                    <!--<button onclick="addJingdianqqqqqqqq()" type="button" class="layui-btn layui-btn-warm">
                        添加到购物车
                    </button>-->
                </div>
            ...
            <div class="layui-tab layui-tab-card">
                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item layui-show">
                        <div v-html="detail.jingdianContent"></div>
                    </div>
                    ...
                    <div class="layui-tab-item">
                        <div class="message-container">
                            <form class="layui-form message-form" style="padding-right: 20px;border-bottom: 0;">
                                <div class="layui-form-item layui-form-text">
                                    ...
                                    <div class="layui-input-block">
                                        <textarea name="jingdianLiuyanContent" id="jingdianLiuyanContent" required lay-verify="required" placeholder="留言内容"
                                                  class="layui-textarea"></textarea>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
                                        <button class="layui-btn btn-submit" lay-submit lay-filter="jingdianLiuyanContent">立即提交</button>
                                        <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                                    </div>
                                </div>
                            </form>
                            <div class="message-list">
                                <div class="message-item" v-for="(item,index) in jingdianLiuyanDataList" v-bind:key="index">
                            ...
                            <div class="pager" id="jingdianLiuyanPager"></div>
                        </div>
                    </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        // 提交留言
        form.on('submit(jingdianLiuyanContent)', function (data) {
            data.yonghuId = localStorage.getItem('userid');
            data.tableName = localStorage.getItem('userTable');
            data.jingdianLiuyanContent =jquery("#jingdianLiuyanContent").val();
