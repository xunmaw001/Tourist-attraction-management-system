    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.yonghuName" type="text" name="yonghuName" id="yonghuName" placeholder="游客姓名" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
...
<!-- 手机号 -->
            <div class="layui-form-item" pane>
                <label class="layui-form-label">游客手机号</label>
                <div class="layui-input-inline">
                    <input v-model="detail.yonghuPhone" type="text" name="yonghuPhone" id="yonghuPhone"  lay-verify="phone|required"   placeholder="游客手机号" autocomplete="off" class="layui-input">
                </div>
            </div>
        <!-- 身份证号 -->

            <div class="layui-form-item" pane>
                <label class="layui-form-label">游客身份证号</label>
                <div class="layui-input-inline">
                    <input v-model="detail.yonghuIdNumber" type="text" name="yonghuIdNumber" id="yonghuIdNumber"  lay-verify="identity|required"   placeholder="游客身份证号" autocomplete="off" class="layui-input">
                </div>
            </div>
        
            <div class="layui-form-item" pane>
                <label class="layui-form-label">游客头像：</label>
