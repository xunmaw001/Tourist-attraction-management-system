            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">游客管理</li>
                        <li class="breadcrumb-item active">编辑游客</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="yonghuPhone" name="yonghuPhone" class="form-control"
                                               onchange="yonghuPhoneChickValue(this)"  placeholder="游客手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>游客身份证号</label>
                                        <input id="yonghuIdNumber" name="yonghuIdNumber" class="form-control"
                                               onchange="yonghuIdNumberChickValue(this)"  placeholder="游客身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>游客头像</label>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                password: "密码不能为空",
                yonghuName: "游客姓名不能为空",
                yonghuPhone: "游客手机号不能为空",
                yonghuIdNumber: "游客身份证号不能为空",
                yonghuPhoto: "游客头像不能为空",
                sexTypes: "性别不能为空",
            }
        }).form();
    }
