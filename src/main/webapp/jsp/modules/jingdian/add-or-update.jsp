                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jingdianNewMoney" name="jingdianNewMoney" class="form-control"
                                               onchange="jingdianNewMoneyChickValue(this)"  placeholder="门票参考价格">
                                    </div>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                jingdianTese: "required",
                jingdianLuxian: "required",
            ...
            messages: {
                ...
                jingdianTese: "景点特色不能为空",
                jingdianLuxian: "景点路线不能为空",
                jingdianContent: "景点详情不能为空",
                jingdianNewMoney: "门票参考价格不能为空",
            }
        }).form();
    }
