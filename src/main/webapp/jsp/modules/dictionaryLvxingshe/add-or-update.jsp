    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑旅行社星级类型</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">旅行社星级类型管理</li>
                        <li class="breadcrumb-item active">编辑旅行社星级类型</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">旅行社星级类型表信息</h3>
...
<script>
    ...
    var tableName = "dictionaryLvxingshe";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "lvxingshe_types";
            data["dicName"] = "旅行社星级类型名称";
