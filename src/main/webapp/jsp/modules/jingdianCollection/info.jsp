    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑景点收藏</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">景点收藏登记</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">景点收藏信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="jingdianName" name="jingdianName" class="form-control"
                                                   v-model="ruleForm.jingdianName" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jingdianValue" name="jingdianValue" class="form-control"
                                               v-model="ruleForm.jingdianValue" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jingdianDengjiValue" name="jingdianDengjiValue" class="form-control"
                                               v-model="ruleForm.jingdianDengjiValue" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>景点缩略图</label>
                                        <img id="jingdianPhotoImg" width="100" height="100">
                                    </div>

                                        <div class="form-group col-md-6">
                                            <label>景点特色</label>
                                            <input id="jingdianTese" name="jingdianTese" class="form-control"
                                                   v-model="ruleForm.jingdianTese" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="jingdianLuxian" name="jingdianLuxian" class="form-control"
                                                   v-model="ruleForm.jingdianLuxian" readonly>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="jingdianNewMoney" name="jingdianNewMoney" class="form-control"
                                                   v-model="ruleForm.jingdianNewMoney" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="jingdianId" name="jingdianId" v-model="ruleForm.jingdianId" readonly type="hidden">
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jingdianCollection/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.jingdianContent != null && ruleForm.jingdianContent != 'null' && ruleForm.jingdianContent != '') {
            var jingdianContentUeditor = UE.getEditor('jingdianContentEditor');
                jingdianContentUeditor.ready(function () {
                    var mes = '' + ruleForm.jingdianContent;
                    jingdianContentUeditor.setContent(mes);
                    jingdianContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function exit() {
        ...
        window.sessionStorage.removeItem('addjingdianCollection');
